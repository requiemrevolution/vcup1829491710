...
define config.after_load_transition = Dissolve(3.0)
...
define config.save_directory = "vcup-1685330637"
...
# define build.itch_project = "renpytom/test-project"
    style.nvl_dialogue.size = 40
    #style.nvl_dialogue.font = "LIBSA1.TTF"
    style.nvl_dialogue.color = "#00008B"
    ...
    style.nvl_dialogue.xsize = 1500
    ## ------ Framed (adjustable) NVL box ---------
    style.nvl_window.background = Frame("gui/nvl.png", 0, 0)
