...
define gui.radio_button_borders = Borders(22, 5, 5, 5)

define gui.check_button_borders = Borders(22, 5, 5, 5)
...
define gui.choice_button_width = 926
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(118, 6, 118, 6)
...
define gui.slot_button_width = 324
define gui.slot_button_height = 242
...
define config.thumbnail_height = 169
...
## side of the screen.
define gui.navigation_xpos = 47

## The vertical position of the skip indicator.
define gui.skip_ypos = 12

## The vertical position of the notify screen.
define gui.notify_ypos = 53
...
define gui.confirm_frame_borders = Borders(47, 47, 47, 47)

## The frame that is used as part of the skip screen.
define gui.skip_frame_borders = Borders(19, 6, 59, 6)

## The frame that is used as part of the notify screen.
define gui.notify_frame_borders = Borders(19, 6, 47, 6)
...
define gui.history_height = 165

## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.history_name_xpos = 182
define gui.history_name_ypos = 0
define gui.history_name_width = 182
define gui.history_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.history_text_xpos = 200
define gui.history_text_ypos = 3
define gui.history_text_width = 868
...
define gui.nvl_borders = Borders(0, 12, 0, 240)
...
## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.nvl_name_xpos = 504
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 176
...
define gui.nvl_thought_xpos = 282
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 915
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 528
define gui.nvl_button_xalign = 0.0
define gui.nvl_dialogue.size = 300
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(47, 17, 47, 0)
    ...
    def small():
        ...
        gui.textbox_height = 282
        gui.name_xpos = 94
        gui.dialogue_xpos = 106
        gui.dialogue_width = 1290

        ## Change the size and spacing of various things.
        gui.slider_size = 43

        gui.choice_button_width = 1454
        gui.choice_button_text_size = 36

        gui.navigation_spacing = 24
        gui.pref_button_spacing = 12

        gui.history_height = 223
        gui.history_text_width = 809
        ...
        gui.nvl_name_width = 358
        gui.nvl_name_xpos = 381

        gui.nvl_text_width = 1073
        gui.nvl_text_xpos = 405
        gui.nvl_text_ypos = 6

        gui.nvl_thought_width = 1454
        gui.nvl_thought_xpos = 24

        gui.nvl_button_width = 1454
        gui.nvl_button_xpos = 24
